  ...
  <footer class="section footer-classic context-dark bg-image" style="background: #2d3246;">
      ...
      <div class="row row-30">
        <div class="col-md-4 col-xl-5">
          <div class="pr-xl-4"><a class="brand" href="index.html"><img class="brand-logo-light"
            ...
            <p>Some required description</p>
            <!-- Rights-->
            <p class="rights"><span>©  </span><span
                class="copyright-year">2020</span><span> </span><span>Waves</span><span>. </span><span>All Rights
                Reserved.</span></p>
          </div>
        </div>
        <div class="col-md-4">
          ...
          <dl class="contact-list">
            <dt>Address:</dt>
            <dd>Jagdamba Shree Peetham<br>
              Jagdamba shree puram<br>
              Near madhusoodan school<br>
              Ayodhya<br>
              PIN: 224123
            </dd>
          </dl>
          <dl class="contact-list">
            <dt>email:</dt>
            <dd><a href="mailto:#">@gmail.com</a></dd>
          </dl>
          <dl class="contact-list">
            <dt>phones:</dt>
            <dd><a href="tel:#">9812312315</a> <span>or</span> <a href="tel:#">9812312315</a>
            </dd>
          </dl>
        </div>
    ...
    <div class="row no-gutters social-container">
      <div class="col"><a class="social-inner" href="#"><span
            class="icon mdi mdi-instagram"></span><span>facebook</span></a></div>
      <div class="col"><a class="social-inner" href="#"><span
